	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-3 content">
				...
				<p class="detail">단어를 소리 내어 발음하는 데에 어려움이 있고(틀린 발음, 혼란된 발음), 읽기
					...
					움직이는 방향을 헷갈려 하는 경우를 말합니다. 대개 미취학 시기부터 단어를 이해하는데 어려움을 겪거나, 발음을 자주
					틀리게 하거나, 말을 더듬는 등의 증상이 나타날 수 있으며, 취학 초기에는 글씨를 베껴 적는데 어려움을 겪거나, 학습
					자체에 취미를 잃기가 쉽습니다. 그러나 사물이나 그림, 도표의 의미를 받아들이는 능력에는 지장이 없어 지능 저하로 인한
					학습 장애와는 감별됩니다.</p>
				<img src="${cp }/image/clinic3_check.png"
					style="margin-left: 10%; margin-top: 3%; margin-bottom: 5%;">
				<h5>2. 쓰기 장애</h5>
				<p class="detail">철자의 오류가 매우 많고, 반복적인 학습에도 불구하고 철자의 혼란이 교정되지
					않으며, 일기 쓰기 등에서 내용이 매우 미숙하고 문법적인 오류를 많이 보입니다.</p>
				<h5>3. 산수 장애</h5>
				...
				<p class="detail">학습장애는 기본적으로 중추신경계, 특히 대뇌의 특정 영역의 발달적인 기능 장애로
					인한 것으로 보고되고 있습니다. 물론 자기 조절적 행동, 사회 지각에서의 문제가 공존할 수 있으나, 이것이 단독으로
					학습장애를 일으키는 것은 아닙니다. 유전적인 기반을 갖는 특정 뇌 영역과 뇌 영역 간의 연결망의 발달적 결함에 의해서
					발병하는 질환이므로, 특정 정보 처리 과정의 결함을 유발하는 뇌 영역 및 연결망의 활성화를 위한 치료적인 도움이
					필요합니다.</p>
