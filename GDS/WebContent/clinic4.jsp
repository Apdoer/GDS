...
<div id="clinic" class="container">
	...
	<div class="row">
		...
		<div class="col-xs-8 col-xs-offset-3 content">
				...
				<h4>
					<img src="${cp }/image/icon4.png"> 사회성부족이란?
				</h4>
				<p class="detail">사회성은 누군가가 타인이나 기타 다른 주변 환경과 “관계”를 형성해 나가면서,
					타인과 원만하게 상호작용하는 능력, 다양한 사람과 긍정적인 관계를 형성하는 능력, 상황에 맞는 행동을 하는 능력을
					말합니다. 그러나 특히 학령기 혹은 유아기에 사회성이 부족하면 친구들과 어울리기 어렵고 다소 상황에 맞지 않는 상황
				...
				<p class="detail">사회성은 아이의 발달단계에 있어 상위 레벨의 기능입니다. 이에 기초 공사에 해당되는
					전정기관의 회복이 선행되지 않고서는 사회성 발달을 기대하기 어렵습니다. 사회성 발달과 관계하는 감각 기관의 회복을
					기본으로 훈련하면서, 교육적인 부분을 가미할때 효과는 배가 될 것입니다.</p>
