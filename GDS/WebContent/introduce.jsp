...
<div id="introduce" class="container">
		...
		<!-- board left-side-bar -->
		<div class="col-xs-3 left-side-bar affix">
			<ul class="pull-left">
	...
	<div class="row">
		<div class="col-xs-8 col-xs-offset-3 content">
			...
			<hr >
            <h2 class="title">협력기관</h2><div id="4"></div>
			<div>
            ...
            <div class="detail">
	          	  본 센터는 예약제로 운영됨이 원칙이나, 언제든 개방되어 있습니다.<br>
            ...
            <div class="detail">
	            <div>
					<img class="img-rounded" alt="" src="${cp}/image/map_2.png" style="width: 100%;">
				</div>
				<div style="margin-top: 20px;">
					<h4><img src="${cp }/image/icon4.png"> 도로명주소</h4>
