...
#introduce .left-side-bar ul li a { display: inline-block; padding: 8px 16px; color: #aaa; font-size: 1.2em; text-decoration: none; }
      ...
      <div class="row">
		...
		<div class="col-md-3 left-side-bar">
			...
			<ul class="pull-right">
				...
				<li><a href="#2">추천사</a></li>
				<li><a href="#3">운영방식 및 시간</a></li>
				<li><a href="#4">오시는길</a></li>
			</ul>
