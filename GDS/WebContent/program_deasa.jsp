         ...
         <div class="blog-header" style="height: 150px;">
          ...
          <div class="blog-post">
          	<div style="float: left; width: 65%; ">
			  	<p style="line-height: 150%;">미국 Great Plains Laboratory 연구소는 광범위한 정신적,<br>
			  	 대사적 장애(자폐를 포함하여 인지발달장애, 다운증후군, ADHD,<br>
			  	  우울증 등 정신질환 까지)를 갖고 있는 성인과 아동을 돕기<br>
			  	  위한 생화학 연구소입니다.<br>
			  	 건강대사이상과 생의학연구 분야에서 상당한 권위를 가진 <br>
			  	 윌리엄 쇼 박사가 설립했고, 운영하고 있습니다.<br>
			  	 Great Plains Laboratory는 발달 장애와 관련된 질환들을 <br>
			  	 과학적으로 원인을 분석 대처하고, 테스트 할 수 있는 기반을 마련해 놓고 있습니다.<br>
			  	  미국에서는 공식적으로 의사의 도움을 받아 테스트가 진행되고 있으며,<br>
			  	   전 세계적으로 몇개의 지사가 있어 많은 국가의 사람들에게<br>
	           	  도움을 주고 있습니다. 특히 유기산 검사는 타 연구소에서 <br>
	           	  따라올 수 없는 독보적 기술과 특허를 갖고 대사건강의 가장 정확한 지표를 제공합니다.	</p>
           	</div>  
            ...
            <p style="line-height: 200%;">유기산 테스트(Organic Acids Test)는 인체가 소변을 통해 모든대사활동 후 대사물질을 흘려 보내는 것을 토대로 신진대사와 관련된 간단하지만 소중한 정보를 제공합니다.
                            신진대사 후에 흘려진 유기산 성분들은 인체 내 세포의 활동에 대한 결과, 음식에 대한 소화결과 그리고 위장의 신진대사로 인한 부산물이라고 할 수 있습니다.<br>
		            어느 부분에선, 소변에 있는 유기산 성분은 유독성과 같은 표시물의 암시를 나타내기도 하며, 효모균이나 위장의 박테리아 대사들의 수준까지 검사되며 평균
		             사람의 대사량과 비교될 수 있는데 이는 효모균이나 박테리아의 확동에 대한 전반적인 상황까지 체크하게 됩니다.<br>
            ...
            <p style="line-height: 200%;">머리카락은 유독성 금속들인 납, 알루미늄, 슨은 등을 검출하는데 탁원한 샘플입니다. 납은 도로변의 흙에서 발견될 수도 있고 오래된 집들의 페인트에도 들어있으며 흙이나 페인트 조각들을 먹는
