      ...
      <div class="row">         
        <div class=" col-md-8 col-md-offset-3 blog-main">
		     ...
		     <p style="line-height: 200%;">
				 ...
				 눈 구조에 문제가 전혀 없는데도 불구하고 다양하게 나타나는 시지각적 문제는 바로 뇌신경의 ‘네트워크 형성’의 실패에서 <br>비롯되게 되는 것입니다.
				 시지각적 문제로 인해, 시각적 집중력이 매우 짧고, 동작추적이 잘 되지 않거나 시각적 기억이 되지 않아 <br>인지발달 장애를 가져오고, 그로 인해 언어발달 장애는 물론 학습장애로 이어지게 됩니다.
				 전반적인 발달장애가 없더라도 <br>시지각 문제로 인해 학습장애 고통을 겪는 아동들은 너무 많이 있습니다.
		     </p>
		     <hr>
          	 <div class="blog-post">
			  	<div id="1">
				...
				<div id="2">
					<h4><img src="image/icon4.png"> 비젼(Vision)이란?</h4><br>
		            <p style="line-height: 200%; margin-left: 20px;">
		            	시력은 단순히 정상적인 범위에서 대상을 명확하게 볼 수 있는 능력입니다.
		            	<br><br>
						비젼(Vision)은 단순히 보는 것만이 아니라, 검색(Inspection), 분별(Discrimination), 식별
						(Identity),<br> 해석(Interpretation)하는 등 시지각적 정보를 받아들이고 처리하는 일련의 과정입
						니다.
		            </p>
	            	<img class="sagin" src="image/im_8.png">
		            <h4 style="margin-top: 50px;"><img src="image/icon4.png"> 학습에 필요한 비젼 기술들</h4><br>
		            <p style="line-height: 150%; margin-left: 20px;">
			            - 물질적인 비젼 기술(안구 운동과의 관계) : 양안의 협응 능력과 안구의 정확한 초점 조절
			                            훈련 등 안구의 움직임을 원활하게 하는 기술(이러한 기술은 시각적인 학습능력
						    을 키워줄 뿐만 아니라 일상생활에도 큰 영향을 미치는 기술임).
						  <br><br>
			 			- 시각적인 프로세싱기술 : 눈으로 시각적인 정보를 받아 그 정보를 인지하는 기술.
						  <br><br>
						- 다른 감각 기관(청각) 및 운동 기관과의 협응 및 통합 : 소리로(청각) 들은 것을 이미지화
						    하여 떠올리는 것(청각적인 교육을 통해 이미지 연상 후 하는 시각화 훈련) 등.
		            </p>
		            <img class="sagin" src="image/effect_02.png">
		            <h4 style="margin-top: 50px;"><img src="image/icon4.png"> 프로그램</h4><br>
		            <p style="line-height: 150%; margin-left: 20px;">
			            - HTS (Home Vision Therapy System) : 안구 초점 조절 훈련 프로그램
						  <br>
			 			- PTSll (Perceptual Therapy System) : 좌/우 뇌의 시지각 발달 훈련 프로그램
						  <br>
						- PVT (Perceptual Visual Tracking Program) : 시지각적 추적능력 및 처리속도 훈련 프로그램
		            </p>
				</div>
			<hr>
			<div id="3">
            <h2 class="blog-post-title">Cellfield(셀필드)</h2>
            <p>
				Cellfield (셀필드) 시지각훈련 프로그램은 세계 최초로 개발된 뇌신경 네트워크 회로를 새롭게 구축하기 위한 특별한 <br>프로그램 입니다. 
				<br><br>
				셀필드 시지각훈련은 좌뇌를 활성화시켜 시지각적 변별력부터 시각적 기억력 등 뇌신경활성화를 목표로 개발된 프로그램
				입니다. <br>학습과 인지성장에 필요한 시각적 기억능력을 굉장한 수준으로 올려서 시각적 이해력이 폭넓게 개선되게 됩니다. 보통 
				일 년 정도<br> 훈련을 해야 얻을 수 있는 결과를 단 2주만의 셀필드 훈련으로 단축할 수 있습니다.
            </p>
